...
public partial class ExpressionSimplifier
{
    ...
    /// <summary>
    /// The expression <c>SEQ(-0&lt;16&gt; - (x != 0&lt;16&gt;), -x)</c> appears a lot in
    ...
    private Expression? FuseComplements(DataType dt, Expression[] exps)
    {
    ...
    private Expression? FuseLogicalOperations(DataType dt, Expression[] exps)
    {
