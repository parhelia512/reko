...
namespace Reko.Arch.Mips
{
    ...
    public class NanoO32CallingConvention : AbstractCallingConvention
    {
        ...
        public NanoO32CallingConvention(IProcessorArchitecture arch, bool allowFpRegs) : base("")
        {
            this.arch = arch;
            ...
            this.fregs = new[] { "f12", "f13", "f14", "f15" }
                .Select(r => arch.GetRegister(r)!)
                .ToArray();
            this.iret = arch.GetRegister("r4")!;
            this.fret = arch.GetRegister("f1")!;
            this.iret2 = arch.GetRegister("r5")!;
