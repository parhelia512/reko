        ...
        public IEnumerator<RtlInstructionCluster> GetEnumerator()
        {
            while (dasm.MoveNext())
            {
                ...
                try
                {
                    ...
                    case Mnemonic.adcs: RewriteAdcSbc(CommonOps.IAddC, this.NZCV); break;
                    ...
                    case Mnemonic.sbcs: RewriteAdcSbc(CommonOps.ISubC, NZCV); break;
                    ...
                    case Mnemonic.smull: RewriteMull(PrimitiveType.Int32, PrimitiveType.Int64, Operator.SMul); break;
                    case Mnemonic.smull2: RewriteSimdBinary(intrinsic.smull2, Domain.SignedInt); break;
                    case Mnemonic.smulh: RewriteMulh(PrimitiveType.Int64, PrimitiveType.Int128, Operator.SMul); break;
                    ...
                    case Mnemonic.umulh: RewriteMulh(PrimitiveType.UInt64, PrimitiveType.UInt128, Operator.UMul); break;
                    case Mnemonic.umull: RewriteMull(PrimitiveType.UInt32, PrimitiveType.UInt64, Operator.UMul); break;
