        ...
        static BlackfinDisassembler()
        {
            ...
            var instr32 = Mask32(24, 8,
                ...
                (0xE1, Mask(5 + 16, 2,
                    ...
                    Nyi(""))),
                (0xE2, Instr(Mnemonic.JUMP_L, InstrClass.Jump, J(0, 24, 1))),
                (0xE3, Instr(Mnemonic.CALL, InstrClass.Call, J(0, 24, 1))),
            ...
            rootDecoder = Mask(12, 4, new Decoder[16]
            {
                Mask(4, 8,
                    ...
                    (0x01, Mask(0, 4, invalid,
                        (0x0, Instr(Mnemonic.RTS, InstrClass.Return)),
                        (0x1, Instr(Mnemonic.RTI, InstrClass.Return)),
                        (0x2, Instr(Mnemonic.RTX, InstrClass.Return)),
                        (0x3, Instr(Mnemonic.RTN, InstrClass.Return)),
                        (0x4, Instr(Mnemonic.RTE, InstrClass.Return)))),
                    ...
                    (0x04, Mask(3, 1,
                        ...
                        invalid)),
                    (0x05, Mask(3, 1,
                        Instr(Mnemonic.JUMP, InstrClass.Jump, IP0),
                        invalid)),
                    (0x06, Mask(3, 1,
                        Instr(Mnemonic.CALL, InstrClass.Call, IP0),
                        invalid)),
                    (0x07, Mask(3, 1,
                        Instr(Mnemonic.CALL, InstrClass.Call, PCIX0),
                        invalid)),
                    (0x08, Mask(3, 1,
                        Instr(Mnemonic.JUMP, InstrClass.Jump, PCIX0),
                        invalid)),
                ...
                Instr(Mnemonic.JUMP_S, InstrClass.Jump, J12),
