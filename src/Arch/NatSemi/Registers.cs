...
public static class Registers
{
    static Registers()
    {
        ...
        I = new FlagGroupStorage(PSR, (ulong) FlagM.IF, "I");
        P = new FlagGroupStorage(PSR, (ulong) FlagM.PF, "P");
        S = new FlagGroupStorage(PSR, (ulong) FlagM.SF, "S");
        U = new FlagGroupStorage(PSR, (ulong) FlagM.UF, "U");
        N = new FlagGroupStorage(PSR, (ulong) FlagM.NF, "N");
        Z = new FlagGroupStorage(PSR, (ulong) FlagM.ZF, "Z");
        F = new FlagGroupStorage(PSR, (ulong) FlagM.FF, "F");
        V = new FlagGroupStorage(PSR, (ulong) FlagM.VF, "V");
        L = new FlagGroupStorage(PSR, (ulong) FlagM.LF, "L");
        T = new FlagGroupStorage(PSR, (ulong) FlagM.TF, "T");
