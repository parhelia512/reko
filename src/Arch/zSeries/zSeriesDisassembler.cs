    ...
    public class zSeriesDisassembler : DisassemblerBase<zSeriesInstruction, Mnemonic>
    {
        ...
        static zSeriesDisassembler()
        {
            ...
            var cc_decoders = ExtendMask32(32, 4,
                (0x6, Instr(Mnemonic.brcth, InstrClass.CondJump, RILb)),
            ...
            var ec_decoders = ExtendMask48(0, 8,
                ...
                (0x44, Instr(Mnemonic.brxhg, InstrClass.CondJump, RIEe)),
                (0x45, Instr(Mnemonic.brxlg, InstrClass.CondJump, RIEe)),
                ...
                (0x64, Instr(Mnemonic.cgrj, InstrClass.CondJump, RIEb)),
                (0x65, Instr(Mnemonic.clgrj, InstrClass.CondJump, RIEb)),
                (0x70, Instr(Mnemonic.cgit, RIEa)),
                (0x71, Instr(Mnemonic.clgit, RIEa)),
                (0x72, Instr(Mnemonic.cit, RIEa)),
                (0x73, Instr(Mnemonic.clfit, RIEa)),
                (0x76, Instr(Mnemonic.crj, InstrClass.CondJump, RIEb)),
                (0x77, Instr(Mnemonic.clrj, InstrClass.CondJump, RIEb)),
                (0x7C, Instr(Mnemonic.cgij, InstrClass.CondJump, RIEc)),
                (0x7D, Instr(Mnemonic.clgij, InstrClass.CondJump, RIEc)),
                (0x7E, Instr(Mnemonic.cij, InstrClass.CondJump, RIEc)),
                (0x7F, Instr(Mnemonic.clij, InstrClass.CondJump, RIEc)),
            ...
            decoders = new Decoder[256]
            {
                ...
                Instr(Mnemonic.balr, InstrClass.Call, RR),
                Instr(Mnemonic.bctr, InstrClass.CondJump, RR),
                Mask(4, 4,
                    Instr(Mnemonic.nopr, InstrClass.Linear|InstrClass.Padding, R),
                    Instr(Mnemonic.bor, InstrClass.CondJump, R),
                    Instr(Mnemonic.bhr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnler, InstrClass.CondJump, R),
                    Instr(Mnemonic.blr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnher, InstrClass.CondJump, R),
                    Instr(Mnemonic.blhr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bner, InstrClass.CondJump, R),
                    Instr(Mnemonic.ber, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnlhr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bher, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnlr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bler, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnhr, InstrClass.CondJump, R),
                    Instr(Mnemonic.bnor, InstrClass.CondJump, R),
                    Instr(Mnemonic.br, InstrClass.Jump, R)),
                invalid,
                invalid,
                Instr(Mnemonic.svc, InstrClass.Call, I),
                Instr(Mnemonic.bsm, InstrClass.Jump, RR),

                Instr(Mnemonic.bassm, InstrClass.Call, RR),
                Instr(Mnemonic.basr, InstrClass.Call, RR),
                ...
                Instr32(Mnemonic.bal, InstrClass.Call, RXa),
                Instr32(Mnemonic.bct, RXa),
                ExtendMask32(20, 4,
                    Instr(Mnemonic.nop, InstrClass.Linear|InstrClass.Padding),
                    Instr(Mnemonic.bo, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bh, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bnle, InstrClass.CondJump, RXb),

                    Instr(Mnemonic.bl, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bnhe, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.blh, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bne, InstrClass.CondJump, RXb),

                    Instr(Mnemonic.be, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bnlh, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bhe, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bnl, InstrClass.CondJump, RXb),

                    Instr(Mnemonic.ble, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bnh, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.bno, InstrClass.CondJump, RXb),
                    Instr(Mnemonic.b, InstrClass.Jump, RXb)),
                ...
                Instr32(Mnemonic.bas, InstrClass.Call, RXa),
                ...
                Instr32(Mnemonic.brxh, InstrClass.CondJump, RSI),
                Instr32(Mnemonic.brxle, InstrClass.CondJump, RSI),
                Instr32(Mnemonic.bxh, InstrClass.CondJump, RSar),
                Instr32(Mnemonic.bxle, InstrClass.CondJump, RSar),
                ...
                ExtendMask32(16, 4,
                    ...
                    (0x04, Mask(20, 4,
                        Instr(Mnemonic.brc, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jo, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jh, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jnle, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jl, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jnhe, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jlh, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jne, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.je, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jnlh, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jhe, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jnl, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jle, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jnh, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.jno, InstrClass.CondJump, RIc),
                        Instr(Mnemonic.j, InstrClass.Jump, RIc))),
                ...
                ExtendMask48(32, 4,
                    ...
                    (0x4, Mask(36, 4,
                        Instr(Mnemonic.brcl, InstrClass.CondJump,  RILc),
                        Instr(Mnemonic.jgo, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgh, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgnle, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgl, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgnhe, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jglh, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgne, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jge, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgnlh, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jghe, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgnl, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgle, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgnh, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jgno, InstrClass.CondJump, RILc),
                        Instr(Mnemonic.jg, InstrClass.CondJump, RILc))),
                    (0x5, Instr(Mnemonic.brasl, InstrClass.Call,  RILb))),
                invalid,
                c2_decoders,
                invalid,
