...
void __do_global_dtors_aux()
{
	if (g_ptr10000878->dw0008 == 0x00)
	{
		...
		if (*r3_n != null)
		{
			<anonymous> ** r2_n = (<anonymous> **) ((char *) r3_n + 4);
			while (true)
			{
				<anonymous> * r25_n = (<anonymous> *) *r3_n;
...
// 004008D0: void main(Register int32 r4, Register (arr (ptr32 char)) r5, Register word32 r16, Register word32 ra)
void main(int32 r4, char * r5[], word32 r16, word32 ra)
{
	word32 r5_n;
	word32 r4_n;
	...
	*g_ptr100008A0 = (char **) ((char *) &g_ptr10000A40->dw038C + 0x0011);
				...
				for (dwLoc0158_n = r2_n->ptr0008; dwLoc0158_n != null; dwLoc0158_n = dwLoc0158_n->ptr17B8)
				{
					if (dwLoc0158_n != null && ((dwLoc0158_n->t0000).u0 >= 0x00 && ((fp->aFED0)[(dwLoc0158_n->t0000).u0 >> 0x05] >> ((dwLoc0158_n->t0000).u0 & 0x1F) & 0x01) != 0x00))
					{
						...
						if (dwLoc0158_n->dw07D8 <= 0x00)
						{
							if (dwLoc0158_n->t0000.u0 >= 0x00)
							{
								close(dwLoc0158_n->t0000.u0);
								dwLoc0158_n->t0000.u0 = -1;
								r5_n = (struct Eq_n *) <invalid>;
								r28_n = (struct Eq_n *) 0x10008860;
							}
						}
					...
					if (dwLoc0158_n != null && ((dwLoc0158_n->t0004).u0 >= 0x00 && ((fp->aFED0)[(dwLoc0158_n->t0004).u0 >> 0x05] >> ((dwLoc0158_n->t0004).u0 & 0x1F) & 0x01) != 0x00))
					{
						...
						if (dwLoc0158_n->dw178C <= 0x00)
						{
							if (dwLoc0158_n->t0004.u0 >= 0x00)
							{
								close(dwLoc0158_n->t0004.u0);
								dwLoc0158_n->t0004.u0 = -1;
								r5_n = (struct Eq_n *) <invalid>;
								r28_n = (struct Eq_n *) 0x10008860;
							}
						}
...
{
	struct Eq_n * r2_n = malloc((size_t) 6100);
	if (r2_n == null)
	{
		word32 r5_n;
		word32 r6_n;
	...
	else
	{
		...
		r2_n->dw1790 = r7;
		r2_n->t0004.u0 = (int32) open_destination(&r2_n->w17A8, ra);
		if (r2_n->t0004.u0 < 0x00)
		{
			word32 r5_n;
			word32 r6_n;
			word32 r7_n;
		...
		else
		{
			...
			r2_n->t17CC = time(null);
			r2_n->t17D0 = time(null);
			if (r7 != 0x00)
			{
				if (r7 == 1)
				{
...
void client_parse_request(struct Eq_n * r4, word32 ra)
{
	ptr32 fp;
	byte * dwLoc40_n = (char *) &r4->t0004 + 4;
	int32 r2_n = r4->dw07D8;
	void * dwLoc28_n = (void *) (&r4->dw07D8 + 1);
	struct Eq_n * dwLoc20_n = r4->ptr0FB4;
	while (r2_n > 0x00)
	{
		byte * r2_n = get_a_line(fp + -0x0810, dwLoc40_n, fp + -0x0818);
		...
		if (r2_n != 1)
		{
			...
			else
			{
				...
				else if (false && strncasecmp("Content-Length: ", fp + -0x0810, 0x0A) == 0x00)
...
// 00402A60: Register (ptr32 void) add_to_request(Register (ptr32 Eq_n) r4, Register (ptr32 void) r5, Register (ptr32 void) r6, Register Eq_n r7, Register word32 ra, Register out (ptr32 Eq_n) r5Out, Register out (ptr32 Eq_n) r6Out, Register out (ptr32 Eq_n) r7Out)
// Called from:
//      client_prepare_connect
//      client_parse_request
void * add_to_request(struct Eq_n * r4, void * r5, void * r6, Eq_n r7, word32 ra, struct Eq_n & r5Out, struct Eq_n & r6Out, struct Eq_n & r7Out)
{
	struct Eq_n * r5_n;
	struct Eq_n * r6_n;
	struct Eq_n * r7_n;
...
// 00402C1C: Register (ptr32 byte) get_a_line(Register (ptr32 byte) r4, Register (ptr32 byte) r5, Register (ptr32 int32) r6)
// Called from:
//      client_parse_request
byte * get_a_line(byte * r4, byte * r5, int32 * r6)
{
	byte * dwArg00_n = r4;
	byte * dwArg04_n = r5;
...
//      main
//      client_new
struct Eq_n * client_send_request(struct Eq_n * r4, word32 ra, struct Eq_n & r25Out)
{
	r4->t17CC = time(null);
	struct Eq_n * r5_n = (struct Eq_n *) <invalid>;
...
word32 client_check_reply_http(struct Eq_n * r4)
{
	...
	while (dwLoc14_n > 0x00 && (dwLoc18_n->b0000 == 0x0A || dwLoc18_n->b0000 == 0x0D))
	{
		++dwLoc18_n;
	...
	if (dwLoc14_n >= 5 && strncasecmp(dwLoc18_n, "HTTP", 4) == 0x00)
	{
		...
		do
		{
			...
			if (dwLoc14_n < 2 || dwLoc18_n->b0000 != 0x0A && dwLoc18_n->b0000 != 0x0D || dwLoc18_n[1] != 0x0A && dwLoc18_n[1] != 0x0D)
				continue;
...
// 004036BC: void client_close(Register (ptr32 Eq_n) r4)
// Called from:
//      client_destroy
//      clist_close_all
void client_close(struct Eq_n * r4)
{
	if (r4 != null)
	{
		if (r4->t0000.u0 >= 0x00)
...
// 00403794: Register (ptr32 Eq_n) client_destroy(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      main
//      clist_delete
...
// 00403A1C: Register int32 open_destination(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      client_new
int32 open_destination(struct sockaddr * r4, word32 ra)
{
	int32 r2_n = socket(2, 2, 6);
	int32 r2_n;
	if (r2_n < 0x00)
	{
		__errno_location();
...
// 00403C00: Register (ptr32 Eq_n) clist_new(Register word32 ra, Register out (ptr32 Eq_n) r4Out, Register out (ptr32 Eq_n) r5Out)
// Called from:
//      main
...
// 00403DBC: Register (ptr32 Eq_n) clist_remove(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5)
// Called from:
//      clist_delete
struct Eq_n * clist_remove(struct Eq_n * r4, struct Eq_n * r5)
{
	if (r5 != null)
	{
		if (r5 == r4->ptr0008)
...
// 00403FF8: void clist_delete(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5, Register word32 ra)
// Called from:
//      clist_destroy_all
void clist_delete(struct Eq_n * r4, struct Eq_n * r5, word32 ra)
{
	clist_remove(r4, r5);
	client_destroy(r5, ra);
}

// 00404070: void clist_close_all(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      clist_destroy
void clist_close_all(struct Eq_n * r4, word32 ra)
{
	struct Eq_n * dwLoc18_n;
...
// 00404108: void clist_destroy_all(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      clist_destroy
void clist_destroy_all(struct Eq_n * r4, word32 ra)
{
	while (r4->ptr0008 != null)
		clist_delete(r4, r4->ptr0008, ra);
}

// 004041B0: void clist_destroy(Register (ptr32 Eq_n) r4, Register word32 ra)
void clist_destroy(struct Eq_n * r4, word32 ra)
{
...
struct Eq_n * request_new(ptr32 r4, word32 ra)
{
	...
	else
	{
		...
		r2_n->dw0558 = -1;
		r2_n->dw0554 = 0x00;
		if (r4 != null && request_parse_line(r2_n, r4, ra) == 0x00)
			r2_n = null;
		else
			r2_n = r2_n;
	}
...
void request_save_line(struct Eq_n * r4, void * r5, word32 r6, word32 ra)
{
	...
	{
		++r4->dw0558;
		r4->a0004[r4->dw0558 * 0x04 + 1040] = (byte) malloc((size_t) r6);
...
void * request_add_lines(struct Eq_n * r4, struct Eq_n * r5, void * r6)
{
	...
	for (dwLoc18_n = 0x00; r4->dw0558 >= dwLoc18_n; ++dwLoc18_n)
	{
		...
		{
			if ((int32) r4->a0004[dwLoc18_n + 0x0510] + (r5->t0FAC).u0 < 2000)
			{
...
void request_get_host(struct Eq_n * r4, char * r5, word32 ra)
{
	...
	{
		char * r2_n = strpbrk(r5, " \t");
		char * dwLoc18_n = r2_n;
		if (r2_n != null)
		{
			while (dwLoc18_n < r5 + 0x0100 && (*dwLoc18_n == 0x20 || *dwLoc18_n == 0x09))
				++dwLoc18_n;
...
// 004053F0: void properties_parse_int(Register (ptr32 char) r4, Register word32 r5, Register word32 ra)
void properties_parse_int(char * r4, word32 r5, word32 ra)
{
	char * ptrLoc18;
	strtoul(r4, &ptrLoc18, 0x00);
	if (*ptrLoc18 != 0x00 && ptrLoc18 != r5)
	{
		word32 r5_n;
		word32 r6_n;
		word32 r7_n;
...
// 004054D0: void properties_load(Register (ptr32 char) r4, Register (ptr32 char) r5, Register word32 ra)
// Called from:
//      main
void properties_load(char * r4, char * r5, word32 ra)
{
	char * dwArg04_n = r5;
			...
			if (*r2_n != 0x00)
			{
				...
				else
				{
					...
					*r2_n = 0x00;
					...
					while (((char *) g_ptr10000A40 + (dwLoc014C_n * 0x98 + 8))[4] != 0x20 && dwLoc2C_n == 0x00)
					{
						if (strcasecmp(r2_n, g_ptr10000A40->a0004[dwLoc014C_n].ptr0000) == 0x00)
						{
							...
							if (r2_n != 1)
							{
								...
								{
									if (r2_n == 2)
										*((word32) &g_ptr10000A40->a0004[dwLoc014C_n].t0004 + 0x008C) = (Eq_n[]) (word32) (strchr("1yY", r2_n->u0) > null);
								}
								else
...
// 00405CD0: Register (arr (ptr32 char)) properties_parse_command_line(Register int32 r4, Register (arr (ptr32 char)) r5, Register word32 r16, Register word32 ra)
// Called from:
//      main
char * properties_parse_command_line[](int32 r4, char * r5[], word32 r16, word32 ra)
{
	...
	{
		if (*r5[dwLoc28_n] == 0x2D)
		{
			byte bLoc1C_n = r5[dwLoc28_n][1];
			word32 dwLoc18_n;
			if (bLoc1C_n != 0x00 && (r5)[dwLoc28_n][2] != 0x00)
			...
			while (((char *) r28_n->ptr81E0 + (dwLoc24_n * 0x98 + 8))[4] != 0x20 && dwLoc20_n == 0x00)
			{
				if ((int32) bLoc1C_n != (int32) ((char *) r28_n->ptr81E0 + (dwLoc24_n * 0x98 + 8))[4])
				{
					...
					r5_n = r5_n;
					word32 r2_n;
					if (r2_n == toupper((int32) ((char *) g_ptr10000A40 + (dwLoc24_n * 0x98 + 8))[4]))
						goto l00406004;
					r5_n = r5_n;
				}
				else
...
// 0040628C: Register (ptr32 Eq_n) properties_print_usage(Register Eq_n r4)
// Called from:
//      properties_parse_command_line
struct Eq_n * properties_print_usage(Eq_n r4)
{
	if (r4 != 0x00 && *r4.u0 != 0x00)
		printf("Usage: %s -h ", r4);
	else
		printf("Usage: redir -h ");
	ui32 dwLoc18_n = 0x00;
	while (((char *) g_ptr10000A40 + (dwLoc18_n * 0x98 + 8))[4] != 0x20)
	{
		if (g_ptr10000A40->a0004[dwLoc18_n].t0004.u0 == 2)
		{
			word32 dwLoc14_n;
			if (((word32) *((char *) *g_ptr10000A6C + (int32) ((char *) g_ptr10000A40 + (dwLoc18_n * 0x98 + 8))[4] * 2) & 0x01) != 0x00)
				dwLoc14_n = tolower((int32) ((char *) g_ptr10000A40 + (dwLoc18_n * 0x98 + 8))[4]);
			else
				dwLoc14_n = toupper((int32) ((char *) g_ptr10000A40 + (dwLoc18_n * 0x98 + 8))[4]);
			struct Eq_n * r1_n = (struct Eq_n *) ((char *) g_ptr10000A40 + (dwLoc18_n * 0x98 + 8));
			printf("-%c|%c ", r1_n->b0004, (char) dwLoc14_n);
		}
		else
		{
...
{
	if (**g_ptr100008A0 != 0x00 && *(*g_ptr100008A0) != 0x2D)
	{
...
// 00406FF8: void server_close(Register (ptr32 Eq_n) r4)
// Called from:
//      server_destroy
//      slist_close_all
void server_close(struct Eq_n * r4)
{
	if (r4 != null && (r4->t0000).u0 > 0x00)
	{
		close(r4->t0000.u0);
		r4->t0000.u0 = -1;
	}
...
// 0040708C: void server_destroy(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      slist_delete
void server_destroy(struct Eq_n * r4, word32 ra)
{
	word32 r5_n;
	word32 r6_n;
	word32 r7_n;
...
// 0040720C: void slist_add(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5)
// Called from:
//      main
void slist_add(struct Eq_n * r4, struct Eq_n * r5)
{
	if (r4->ptr0008 != null)
	{
...
// 0040730C: void slist_remove(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5)
// Called from:
//      slist_delete
void slist_remove(struct Eq_n * r4, struct Eq_n * r5)
{
	if (r5 != null)
	{
		if (r5 == r4->ptr0008)
...
// 004074AC: void slist_delete(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5, Register word32 ra)
// Called from:
//      slist_destroy_all
void slist_delete(struct Eq_n * r4, struct Eq_n * r5, word32 ra)
{
	slist_remove(r4, r5);
	word32 r5_n;
	word32 r6_n;
...
// 00407568: void slist_close_all(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      slist_destroy
void slist_close_all(struct Eq_n * r4, word32 ra)
{
	struct Eq_n * dwLoc18_n;
...
// 00407600: void slist_destroy_all(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      slist_destroy
void slist_destroy_all(struct Eq_n * r4, word32 ra)
{
	while (r4->ptr0008 != null)
		slist_delete(r4, r4->ptr0008, ra);
}

// 004076A8: void slist_destroy(Register (ptr32 Eq_n) r4, Register word32 ra)
// Called from:
//      main
void slist_destroy(struct Eq_n * r4, word32 ra)
{
...
void _fpadd_parts(struct Eq_n * r4, struct Eq_n * r5, struct Eq_n * r6)
{
	...
	if ((r7_n ^ 0x04) != 0x00)
	{
		...
		if ((r4_n ^ 0x02) != 0x00)
		{
			...
			if (r3_n != 0x00)
			{
				...
				if (r7_n < 0x00)
				{
					...
					r6->t000C.u0 = (int32) (r7_n & 0x01 | r7_n >> 0x01);
					r6->dw0008 = r2_n + 1;
				}
				else
					r6->t0000.u0 = 3;
		...
		else
		{
			if ((r7_n ^ 0x02) != 0x00)
				return;
			r6->t0000.u0 = (int32) r7_n;
			r6->dw0004 = r4->dw0004;
			r6->dw0008 = r4->dw0008;
			r6->t000C.u0 = r4->t000C.u0;
...
// 00407A38: Register real32 __addsf3(Register real32 f12, Register real32 f14)
real32 __addsf3(real32 f12, real32 f14)
{
	ptr32 fp;
...
// 00407AE0: Register real32 __subsf3(Register real32 f12, Register real32 f14)
real32 __subsf3(real32 f12, real32 f14)
{
	ptr32 fp;
	__unpack_f(fp + -24, fp + -72);
	__unpack_f(fp + -20, fp + -56);
...
// 00407BA0: Register real32 __mulsf3(Register real32 f12, Register real32 f14)
real32 __mulsf3(real32 f12, real32 f14)
{
	uint32 dwLoc2C;
	uint32 dwLoc3C;
	ptr32 fp;
...
// 00407DD0: Register real32 __divsf3(Register real32 f12, Register real32 f14)
real32 __divsf3(real32 f12, real32 f14)
{
	uint32 dwLoc1C;
	uint32 dwLoc2C;
	ptr32 fp;
...
void _fpadd_parts(struct Eq_n * r4, struct Eq_n * r5, struct Eq_n * r6)
{
	...
	if ((r4_n ^ 0x02) == 0x00)
	{
		...
		r6->dw0008 = r4->dw0008;
		r6->dw000C = r4->dw000C;
		r6->t0010.u0 = r4->t0010.u0;
		r6->t0014.u0 = r4->t0014.u0;
		r6->dw0004 = r4->dw0004 & r5->dw0004;
		return;
	}
	ui32 r3_n = r7_n ^ 0x02;
	...
	{
		r6->dw0008 = r12_n;
		r6->t0010.u0 = (int32) r4_n;
		r6->t0014.u0 = (int32) r5_n;
		r6->dw0004 = 0x00;
	}
	else
	{
		...
		r6->dw0008 = r12_n;
		Eq_n r5_n = -r5_n;
		r6->t0010.u0 = (int32) (-r4_n - (word32) (r5_n > 0x00));
		r6->t0014.u0 = (int32) r5_n;
	}
	Eq_n r9_n;
	r9_n.u0 = r6->t0014.u0;
...
l00408490:
	if (r6->t0010.u0 > 0x1FFFFFFF)
	{
		...
		r6->t0010.u0 = (int32) (r4_n >> 0x01);
		r6->t0014.u0 = (int32) (r5_n & 1 | (r5_n >> 0x01 | r4_n << 0x1F));
		r6->dw0008 = r6_n + 1;
	}
	else
		r6->t0000.u0 = 3;
...
// 004084FC: Register real64 __adddf3(Sequence real64 f12:f13, Sequence real64 f14:f15)
real64 __adddf3(real64 f12:f13, real64 f14:f15)
{
	ptr32 fp;
...
// 004085CC: Register real64 __subdf3(Sequence real64 f12:f13, Sequence real64 f14:f15)
real64 __subdf3(real64 f12:f13, real64 f14:f15)
{
	ptr32 fp;
	__unpack_d(fp + -40, fp + -112);
	__unpack_d(fp + -32, fp + -88);
...
// 00408BA0: Register real64 __divdf3(Sequence real64 f12:f13, Sequence real64 f14:f15)
real64 __divdf3(real64 f12:f13, real64 f14:f15)
{
	uint32 dwLoc30;
	uint32 dwLoc44;
	uint32 dwLoc48;
...
// 00408EE0: Register int32 __nedf2(Sequence real64 f12:f13)
int32 __nedf2(real64 f12:f13)
{
	ptr32 fp;
	__unpack_d(fp + -40, fp + -88);
	__unpack_d(fp + -32, fp + -64);
...
// 00408FB0: Register int32 __gedf2(Register real32 f12, Register real32 f14)
int32 __gedf2(real32 f12, real32 f14)
{
	ptr32 fp;
	__unpack_d(fp + -40, fp + -88);
	__unpack_d(fp + -32, fp + -64);
...
// 00409080: Register int32 __ltdf2(Register real32 f12, Register real32 f14)
int32 __ltdf2(real32 f12, real32 f14)
{
	ptr32 fp;
	__unpack_d(fp + -40, fp + -88);
	__unpack_d(fp + -32, fp + -64);
...
// 00409A90: Register int32 __fpcmp_parts_d(Register (ptr32 Eq_n) r4, Register (ptr32 Eq_n) r5)
// Called from:
//      __eqdf2
//      __nedf2
//      __gedf2
//      __ltdf2
int32 __fpcmp_parts_d(struct Eq_n * r4, struct Eq_n * r5)
{
	Eq_n r6_n;
	r6_n.u0 = r4->t0000.u0;
	if (r6_n < 2)
	...
	if ((r6_n ^ 0x04) != 0x00)
	{
		ui32 r2_n = r3_n ^ 0x04;
		if (r2_n == 0x00)
			return -(word32) (r5->t0004.u0 < 1) | 0x01;
		if ((r6_n ^ 0x02) != 0x00)
		{
			if ((r3_n ^ 0x02) == 0x00)
				return -(word32) (r4->t0004.u0 > 0x00) | 0x01;
			Eq_n r8_n;
			r8_n.u0 = r4->t0004.u0;
			word32 r2_n;
			if (r8_n != (r5->t0004).u0)
			{
				r2_n = (word32) (r8_n > 0x00);
				return -r2_n | 0x01;
			}
			else
			{
				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							{
								if (r6_n != r7_n || r4->dw0014 >= r5->dw0014)
									return 0x00;
								r2_n = (word32) (r8_n < 1);
								return -r2_n | 0x01;
							}
	...
	else
	{
		...
		if (r2_n != 0x00)
			return -(word32) (r4->t0004.u0 > 0x00) | 0x01;
		return r5->t0004.u0 - (r4->t0004).u0;
	}
}
