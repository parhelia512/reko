...
void fn0000000000015180(word64 ra, struct Eq_n * gp, int64 a0, char ** a1, word64 a7, word64 s5, word64 s11)
{
	...
	do
	{
		a0_n = (uint64) getopt_long((int32) a0, a1, "cr:i46bho:gmnpsv", &g_t108E0, null);
		if (a0_n == (char *) -1)
		{
			int64 a4_n = (int64) gp->dwF890;
			char * s1_n;
			char * s4_n;
			if (a4_n < a0)
			{
				int64 a1_n = (int64) ((word32) a4_n + 1);
				gp->dwF890 = (word32) a1_n;
			...
			if (qwLoc01A8.dw0004 != 0 && false)
			{
				...
				fwrite(&g_v119D8, (size_t) 1, (size_t) 46, gp->ptrF880);
				goto l00000000000153DC;
			}
			int64 s2_n;
			word64 a6_n;
...
l00000000000153CC:
				...
				{
					if (gp->dwF814 == 0)
						fwrite(&g_v11A08, (size_t) 1, (size_t) 37, gp->ptrF880);
					goto l00000000000153D8;
				}
...
l0000000000015964:
				if (gp->dwF814 != 0)
					goto l00000000000153D8;
				__fprintf_chk(gp->ptrF880, 1, "ipcalc: could not resolve %s\n", null);
				goto l00000000000153DC;
			}
l0000000000015458:
			a5_n = a0_n;
			if (true)
			{
				...
				if (gp->dwF814 != 0)
					goto l00000000000153D8;
				fwrite(&g_v11A30, (size_t) 1, (size_t) 28, gp->ptrF880);
				fn0000000000015FCC(gp, 1);
				goto l00000000000153DC;
			}
			char * a0_n = fn00000000000166F4(gp, (char *) &qwLoc01A8 + 4, null, 1);
			FILE * a0_n;
			char * a3_n;
			char * a4_n;
			if (a0_n < null)
...
l0000000000015CB0:
				if (gp->dwF814 != 0)
					goto l00000000000153D8;
				__fprintf_chk(gp->ptrF880, 1, "ipcalc: cannot generate network with prefix: %u\n", (uint32) a0_n);
				goto l00000000000153DC;
			}
			Eq_n tLoc0188;
			int64 qwLoc0190;
...
l000000000001553C:
				if (gp->dwF814 != 0)
					goto l00000000000153D8;
				__fprintf_chk(gp->ptrF880, 1, "ipcalc: unexpected argument: %s\n", s4_n);
				fn0000000000015FCC(gp, 1);
				goto l00000000000153DC;
			}
			a0_n = strchr(s1_n, '/');
...
l00000000000155E4:
				char * a0_n = fn00000000000166F4(gp, (char *) &qwLoc01A8 + 4, s4_n, 0);
				a5_n = a0_n;
				if (a0_n >= null)
					goto l00000000000155FC;
				if (gp->dwF814 == 0)
...
l00000000000153D8:
			...
			if ((s0_n & 8) == 0x00)
			{
				...
				if ((s0_n & 0x0400) != 0x00)
				{
					char * a2_n = tLoc0188.ptr00A8;
					if (a2_n != null)
						__printf_chk(1, "MINADDR=%s\n", a2_n);
				}
				if (s0_n << 0x34 < 0x00)
				{
					char * a2_n = tLoc0188.ptr00B0;
					if (a2_n != null)
...
l0000000000015914:
				...
				word64 a5_n;
				gp = fn000000000001654C(gp, tLoc0188.ptr0000, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
...
l0000000000015880:
			...
			word64 a6_n;
			word64 a7_n;
			gp = fn000000000001654C(fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7_n), tLoc0188.ptr0000, a4_n, a5_n, a6_n, a7_n, out a4_n, out a5_n, out a6_n, out a7);
			Eq_n a5_n;
			char * a3_n;
			int64 s0_n;
			if (s4_n != 0x00)
...
l0000000000015668:
			...
			word64 a7_n;
			Eq_n a5_n;
			gp = fn000000000001654C(fn000000000001654C(gp, tLoc0188.ptr0020, s2_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7_n), tLoc0188.ptr0030, (int64) tLoc0188.dw00A0, a5_n, a6_n, a7_n, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr0028;
			if (a3_n != null)
			{
				word64 a5_n;
...
l0000000000015C2C:
				...
				if (s0_n == 0x00)
					goto l00000000000156FC;
l00000000000158C8:
				char * a3_n = tLoc0188.ptr00B8;
				if (a3_n != null)
					gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
				char * a3_n = tLoc0188.ptr00C0;
				if (a3_n != null)
				{
					word64 a5_n;
					gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
...
l00000000000156FC:
			...
			if (a3_n != null)
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr00A8;
			if (a3_n != null)
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr00B0;
			if (a3_n != null)
			{
				word64 a5_n;
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
...
l00000000000153DC:
			...
			putchar(0x0A);
			char * a3_n = tLoc0188.ptr0048;
			if (a3_n != null)
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr0040;
			if (a3_n != null)
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr0050;
			if (a3_n != null)
				gp = fn000000000001654C(gp, a3_n, a4_n, a5_n, a6_n, a7, out a4_n, out a5_n, out a6_n, out a7);
			char * a3_n = tLoc0188.ptr0058;
			if (a3_n != null)
			{
				word64 a4_n;
				word64 a5_n;
...
{
	FILE * a3_n = gp->ptrF880;
	if (a0 != 0x00)
	{
		fwrite(&g_v10BE0, (size_t) 1, (size_t) 26, a3_n);
		fwrite(&g_v10C00, (size_t) 1, (size_t) 54, gp->ptrF880);
		fwrite(&g_v10C38, (size_t) 1, (size_t) 77, gp->ptrF880);
		fwrite(&g_v10C88, (size_t) 1, (size_t) 62, gp->ptrF880);
		fwrite(&g_v10CC8, (size_t) 1, (size_t) 79, gp->ptrF880);
		fwrite(&g_v10D18, (size_t) 1, (size_t) 79, gp->ptrF880);
		fwrite(&g_v10D68, (size_t) 1, (size_t) 42, gp->ptrF880);
		fwrite(&g_v10D98, (size_t) 1, (size_t) 76, gp->ptrF880);
		fwrite(&g_v10DE8, (size_t) 1, (size_t) 77, gp->ptrF880);
		fwrite(&g_v10E38, (size_t) 1, (size_t) 77, gp->ptrF880);
		fputc();
		fwrite(&g_v10E88, (size_t) 1, (size_t) 23, gp->ptrF880);
		fwrite(&g_v10EA0, (size_t) 1, (size_t) 71, gp->ptrF880);
		fwrite(&g_v10EE8, (size_t) 1, (size_t) 57, gp->ptrF880);
		fwrite(&g_v10F28, (size_t) 1, (size_t) 58, gp->ptrF880);
		fwrite(&g_v10F68, (size_t) 1, (size_t) 57, gp->ptrF880);
		fwrite(&g_v10FA8, (size_t) 1, (size_t) 77, gp->ptrF880);
		fwrite(&g_v10FF8, (size_t) 1, (size_t) 77, gp->ptrF880);
		fwrite(&g_v11048, (size_t) 1, (size_t) 77, gp->ptrF880);
		fwrite(&g_v11098, (size_t) 1, (size_t) 46, gp->ptrF880);
		fwrite(&g_v110C8, (size_t) 1, (size_t) 72, gp->ptrF880);
		fwrite(&g_v11118, (size_t) 1, (size_t) 45, gp->ptrF880);
		fwrite(&g_v11148, (size_t) 1, (size_t) 67, gp->ptrF880);
		fwrite(&g_v11190, (size_t) 1, (size_t) 64, gp->ptrF880);
		fwrite(&g_v111D8, (size_t) 1, (size_t) 72, gp->ptrF880);
		fwrite(&g_v11228, (size_t) 1, (size_t) 46, gp->ptrF880);
		fputc();
		fwrite(&g_v11258, (size_t) 1, (size_t) 0x0F, gp->ptrF880);
		fwrite(&g_v11268, (size_t) 1, (size_t) 87, gp->ptrF880);
		fwrite(&g_v112C0, (size_t) 1, (size_t) 60, gp->ptrF880);
		fwrite(&g_v11300, (size_t) 1, (size_t) 0x0044, gp->ptrF880);
		fwrite(&g_v11348, (size_t) 1, (size_t) 58, gp->ptrF880);
		fwrite(&g_v11388, (size_t) 1, (size_t) 57, gp->ptrF880);
		fwrite(&g_v113C8, (size_t) 1, (size_t) 62, gp->ptrF880);
	}
	else
	{
		fwrite(&g_v11408, (size_t) 1, (size_t) 77, a3_n);
		fwrite(&g_v11458, (size_t) 1, (size_t) 62, gp->ptrF880);
		fwrite(&g_v11498, (size_t) 1, (size_t) 65, gp->ptrF880);
		fwrite(&g_v114E0, (size_t) 1, (size_t) 76, gp->ptrF880);
		fwrite(&g_v11530, (size_t) 1, (size_t) 65, gp->ptrF880);
		fwrite(&g_v11578, (size_t) 1, (size_t) 41, gp->ptrF880);
		fwrite(&g_v115A8, (size_t) 1, (size_t) 30, gp->ptrF880);
	}
}

// 00000000000163B0: Register (ptr64 Eq_n) fn00000000000163B0(Register (ptr64 Eq_n) gp, Register (ptr64 Eq_n) a0)
// Called from:
//      fn00000000000175BC
union Eq_n * fn00000000000163B0(struct Eq_n * gp, union Eq_n * a0)
{
	ptr64 fp;
	int64 a5_n = gp->qwF870;
	char bLocE8;
	__sprintf_chk(&bLocE8, 1, (size_t) 0x0080, "%.2x", (uint32) a0->u0);
	int64 s0_n = 1;
	byte * s2_n = (char *) a0 + 1;
	...
	if (true)
	{
		do
		{
			__sprintf_chk(s1_n, 1, (size_t) 0x0080, "%.2x", (uint32) *s2_n);
	...
	s1_n->b0000 = 0x00;
	union Eq_n * a0_n = __strdup(&bLocE8);
	if (a5_n == gp->qwF870)
		return a0_n;
	__stack_chk_fail();
}
...
// 000000000001654C: Register (ptr64 Eq_n) fn000000000001654C(Register (ptr64 Eq_n) gp, Register (ptr64 char) a3, Register Eq_n a4, Register Eq_n a5, Register word64 a6, Register word64 a7, Register out int64 a4Out, Register out int64 a5Out, Register out word64 a6Out, Register out word64 a7Out)
// Called from:
//      fn0000000000015180
struct Eq_n * fn000000000001654C(struct Eq_n * gp, char * a3, Eq_n a4, Eq_n a5, word64 a6, word64 a7, int64 & a4Out, int64 & a5Out, word64 & a6Out, word64 & a7Out)
{
	int64 t3_n = gp->qwF870;
	ptr64 fp;
	...
	{
		char * s2_n;
		fputs(s2_n, gp_n->ptrF888);
		if (gp_n->dwF810 != 0)
		{
			char * s3_n;
			fputs(s3_n, gp_n->ptrF888);
		}
		fputs(null, gp_n->ptrF888);
		if (gp_n->dwF810 != 0)
			fwrite(&g_v115E0, (size_t) 1, (size_t) 4, gp_n->ptrF888);
		free(null);
	}
	int64 a5_n = gp_n->qwF870;
	if (t3_n != a5_n)
		__stack_chk_fail();
	else
	{
...
// 0000000000016630: Register (ptr64 char) fn0000000000016630(Register (ptr64 Eq_n) gp, Register (ptr64 char) a0, Register (ptr64 word64) a1)
// Called from:
//      fn00000000000166F4
char * fn0000000000016630(struct Eq_n * gp, char * a0, word64 * a1)
{
	int64 a5_n = gp->qwF870;
...
// 00000000000168E4: Register (ptr64 char) fn00000000000168E4(Register (ptr64 Eq_n) gp, Register (ptr64 char) a0, Register (ptr64 Eq_n) a1)
// Called from:
//      fn0000000000016D74
//      fn00000000000175BC
char * fn00000000000168E4(struct Eq_n * gp, char * a0, struct Eq_n * a1)
{
	int64 a4_n = gp->qwF870;
	uint64 a0_n;
	if (a0 != (char *) 2)
	{
		if (a0 != (char *) 0x0A)
		...
		a0_n = (uint64) getnameinfo(&qwLoc48, 28, &gp->dwF890 + 2, 0x0401, null, 0, 0);
	}
	else
	{
		...
		a0_n = (uint64) getnameinfo(&qwLoc58, 16, &gp->dwF890 + 2, 0x0401, null, 0, 0);
	}
	char * a0_n;
	if (a0_n == 0x00)
	{
		a0_n = __strdup(&gp->dwF890 + 2);
l0000000000016914:
		if (a4_n == gp->qwF870)
			return a0_n;
		__stack_chk_fail();
	...
	if (getaddrinfo(a1, null, &tLoc68, &ptrLoc70) == 0x00)
	{
		...
		if (s0_n != null)
		{
			do
			{
				...
				if (a0_n == 2)
				{
					if (inet_ntop((int32) a0_n, a1_n + 4, &gp->dwF890 + 260, 64) != null)
						goto l0000000000016A88;
				}
				else if (inet_ntop((int32) a0_n, a1_n + 8, &gp->dwF890 + 260, 64) != null)
				{
l0000000000016A88:
					freeaddrinfo(ptrLoc70);
					a0_n = __strdup(&gp->dwF890 + 260);
...
// 0000000000016D74: Register (ptr64 char) fn0000000000016D74(Register word64 ra, Register (ptr64 Eq_n) gp, Register (ptr64 char) a0, Register (ptr64 char) a1, Register (ptr64 Eq_n) a2, Register int64 a3, Register out int64 a4Out)
// Called from:
//      fn0000000000015180
char * fn0000000000016D74(word64 ra, struct Eq_n * gp, char * a0, char * a1, struct Eq_n * a2, int64 a3, int64 & a4Out)
{
	word64 a4_n;
	word64 a3_n;
	word64 a4_n;
	...
	if (inet_pton(2, a0, &qwLoc01B8) <= 0x00)
	{
		...
		__fprintf_chk(gp->ptrF880, 1, "ipcalc: bad IPv4 address: %s\n", a0);
		a0_n = (char *) -1;
l0000000000016E24:
		if (a5_n != gp->qwF870)
			__stack_chk_fail();
	...
	if (a1 >= null)
	{
		...
		if (a1 > (char *) 32)
		{
			if (gp->dwF814 == 0)
			{
				__fprintf_chk(gp->ptrF880, 1, "ipcalc: bad IPv4 prefix %d\n", (int32) a1);
				a0_n = (char *) -1;
	...
	if (inet_ntop(2, &qwLoc01B8, &bLoc0188, 47) != null)
	{
		...
		word64 qwLoc01B0 = (word64) (word32) fn0000000000016830(gp, s5_n);
		bLoc0188 = (char) 0x00;
		...
		word64 qwLoc01A0 = (word64) (word32) (~fn0000000000016830(gp, s5_n) | s0_n);
		bLoc0188 = (char) 0x00;
		...
		if (s5_n != (char *) 31)
		{
			...
			if (inet_ntop(2, &qwLoc0198, &bLoc0188, 16) != null)
			{
				...
				if (inet_ntop(2, &ptrLoc0190, &bLoc0188, 47) != null)
				{
					...
					__snprintf_chk(&a2->b0060, (size_t) 64, 1, (size_t) 64, "%u", (0x01 << (int64) (0x20 - (word32) s5_n)) - 2);
...
l000000000001717C:
			if (a3 << 0x31 < 0x00)
				gp = fn0000000000017B40(ra, gp, (int64) qwLoc01B8, &a2->qw0038 + 1, &a2->qw0038 + 2, &a2->qw0038 + 3, &a2->qw0038 + 4, s5_n, a2, out s1_n, out s6_n);
			if ((a3 & 1) == 0x00)
			{
l000000000001718C:
				a0_n = null;
			...
			word64 a0_n = fn00000000000168E4(gp, (char *) 2, &qwLoc01B8);
			s6_n->qw0038 = a0_n;
			if (a0_n != 0x00)
...
l0000000000017074:
	if (gp->dwF814 == 0)
		fwrite(&g_v117F8, (size_t) 1, (size_t) 43, gp->ptrF880);
	goto l0000000000016E20;
}

// 000000000001730C: Register (ptr64 char) fn000000000001730C(Register (ptr64 Eq_n) gp, Register (ptr64 char) a0, Register (ptr64 word64) a1)
// Called from:
//      fn00000000000175BC
char * fn000000000001730C(struct Eq_n * gp, char * a0, word64 * a1)
{
	int64 a4_n = gp->qwF870;
	char * a0_n;
	if (a0 <= (char *) 0x0080)
...
// 00000000000175BC: Register (ptr64 char) fn00000000000175BC(Register word64 ra, Register (ptr64 Eq_n) gp, Register (ptr64 char) s1, Register (ptr64 char) a0, Register (ptr64 char) a1, Register (ptr64 Eq_n) a2, Register int64 a3, Register out int64 a4Out)
// Called from:
//      fn0000000000015180
char * fn00000000000175BC(word64 ra, struct Eq_n * gp, char * s1, char * a0, char * a1, struct Eq_n * a2, int64 a3, int64 & a4Out)
{
	word64 qwLoc0178;
	word64 qwLoc0188;
	char bLoc0168;
	...
	if (inet_pton(0x0A, a0, &qwLoc0198) <= 0x00)
	{
		...
		__fprintf_chk(gp->ptrF880, 1, "ipcalc: bad IPv6 address: %s\n", a0);
		a0_n = (char *) -1;
		goto l0000000000017774;
	}
	a2->qw0008 = fn00000000000163B0(gp, &qwLoc0198);
			...
			if (a0_n != 0x00)
			{
				...
				if (inet_ntop(0x0A, &qwLoc0178, &bLoc0168, 0x00FA) != null)
				{
					...
					do
					{
						...
						s8_n->u2.bFFFF = (byte) ~(word64) s9_n->u0 | s8_n->u0;
...
l0000000000017728:
			...
			if (gp->dwF814 != 0)
				goto l0000000000017770;
			__fprintf_chk(gp->ptrF880, 1, "ipcalc: error converting IPv6 prefix: %d\n", (int32) s2_n);
			a0_n = (char *) -1;
		}
		else
		{
			if (gp->dwF814 != 0)
				goto l0000000000017770;
			__fprintf_chk(gp->ptrF880, 1, "ipcalc: bad IPv6 prefix: %d\n", (int32) a1);
			a0_n = (char *) -1;
		}
l0000000000017774:
		if (a5_n != gp->qwF870)
...
// 0000000000017924: Register int64 fn0000000000017924(Register (ptr64 Eq_n) gp, Register out (ptr64 Eq_n) a1Out, Register out int64 a2Out, Register out int64 a3Out, Register out int64 a4Out, Register out Eq_n a6Out)
// Called from:
//      fn0000000000015180
//      fn0000000000017B40
//      fn0000000000017D10
int64 fn0000000000017924(struct Eq_n * gp, FILE & a1Out, int64 & a2Out, int64 & a3Out, int64 & a4Out, union Eq_n & a6Out)
{
	int64 s0_n;
	FILE * a1;
	if (gp->ptrF820 == null)
	{
		s0_n = (int64) gp->dwF818;
		if (s0_n == 0x00)
		{
			...
			if (a0_n != null)
			{
				gp->ptrF868 = dlsym(a0_n, "_GeoIP_setup_dbfilename");
				...
				gp->ptrF828 = a0_n;
				gp->ptrF850 = dlsym(a0_n, "GeoIP_code_by_id");
				a1 = (FILE *) g_str12B38;
			...
			{
				__snprintf_chk(&gp->tFCE0.u0, (size_t) 0x0100, 1, (size_t) 0x0100, "ipcalc: could not open %s\n", "/usr/lib64/libGeoIP.so.1");
				gp->dwF818 = ~0x00;
				a3 = 0x0100;
				a4 = 76376;
				a2 = 1;
...
l0000000000017970:
	...
	if (gp->dwF814 == 0 && (gp->tFCE0).u0 != 0x00)
	{
		a1 = gp->ptrF880;
		fputs(&gp->tFCE0.u0, a1);
	}
	s0_n = (int64) gp->dwF818;
	goto l0000000000017970;
}

// 0000000000017B40: Register (ptr64 Eq_n) fn0000000000017B40(Register word64 ra, Register (ptr64 Eq_n) gp, Register int64 a0, Register ptr64 a1, Register ptr64 a2, Register ptr64 a3, Register ptr64 a4, Register (ptr64 char) s5, Register (ptr64 Eq_n) s6, Register out (ptr64 char) s1Out, Register out (ptr64 Eq_n) s6Out)
// Called from:
//      fn0000000000016D74
struct Eq_n * fn0000000000017B40(word64 ra, struct Eq_n * gp, int64 a0, ptr64 a1, ptr64 a2, ptr64 a3, ptr64 a4, char * s5, struct Eq_n * s6, char & s1Out, struct Eq_n & s6Out)
{
	struct Eq_n * a0_n;
	struct Eq_n * a0_n;
	word64 a4_n;
	...
	if (fn0000000000017924(gp, out a1_n, out a2_n, out a3_n, out a4_n, out a6_n) == 0x00)
	{
		...
		if (a0_n != null)
		{
			...
			if (a0_n->r0034 != 0.0F)
			{
				...
				char ** s4_n;
				real64 fa3_n;
				__asprintf_chk(s4_n, 1, "%f,%f", fa3_n, fa4_n);
				real64 a4_n = fa4_n;
				word64 a2_n = 76672;
				int64 a1_n = 1;
			}
...
// 0000000000017D10: Register (ptr64 Eq_n) fn0000000000017D10(Register word64 ra, Register (ptr64 Eq_n) gp, Register (ptr64 char) s1, Register (ptr64 word64) a0, Register ptr64 a1, Register ptr64 a2, Register ptr64 a3, Register ptr64 a4, Register int64 s6, Register (ptr64 word64) s7, Register out (ptr64 void) s0Out, Register out (ptr64 char) s3Out, Register out word64 s4Out, Register out int64 s6Out)
// Called from:
//      fn00000000000175BC
struct Eq_n * fn0000000000017D10(word64 ra, struct Eq_n * gp, char * s1, word64 * a0, ptr64 a1, ptr64 a2, ptr64 a3, ptr64 a4, int64 s6, word64 * s7, void & s0Out, char & s3Out, word64 & s4Out, int64 & s6Out)
{
	struct Eq_n * s0_n;
	struct Eq_n * a0_n;
	struct Eq_n * s0_n;
	...
	if (a0_n == 0x00)
	{
		...
		if (a0_n != null)
		{
			...
			if (a0_n->r0034 != 0.0F)
			{
				...
				char ** s5_n;
				real64 fa3_n;
				__asprintf_chk(s5_n, 1, "%f,%f", fa3_n, fa4_n);
				real64 a4_n = fa4_n;
				word64 a2_n = 76672;
				int64 a1_n = 1;
			}
...
int64 fn0000000000017F04(struct Eq_n * gp, int64 a0, char * a1, int64 a2, int64 a3)
{
	...
	char * ptrLoc50 = 0x00;
	int64 a0_n = fn00000000000182B4(a0, out a3_n, out a4_n);
	int64 a1_n = (int64) ((word32) a0_n >> 16);
	int64 t1_n = (int64) ((word32) a0_n >> 8);
	int64 s6_n = (int64) ((word32) a0_n >> 24);
	Eq_n a0_n;
	if (a1 != (char *) 32)
	{
		if (a1 != (char *) 24)
				...
				if (a1 != (char *) 8)
				{
					if (a1 <= (char *) 24)
					{
						if (a1 <= (char *) 16)
						{
							...
							word64 a3_n;
							word64 a4_n;
							a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u-%u.%u.in-addr.arpa.", (word32) fn00000000000182B4(a2, out a3_n, out a4_n) >> 16 & 0xFF, (word32) fn00000000000182B4(a3, out a3_n, out a4_n) >> 16 & 0xFF, (uint32) s6_n);
						}
						else
						{
							word64 a3_n;
							...
							word64 a3_n;
							word64 a4_n;
							a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u-%u.%u.%u.in-addr.arpa.", (word32) fn00000000000182B4(a2, out a3_n, out a4_n) >> 8 & 0xFF, (word32) fn00000000000182B4(a3, out a3_n, out a4_n) >> 8 & 0xFF, (uint32) a1_n & 0xFF, (uint32) s6_n);
						}
					}
					else
					{
						...
						word64 a3_n;
						word64 a4_n;
						a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u-%u.%u.%u.%u.in-addr.arpa.", (uint32) fn00000000000182B4(a2, out a3_n, out a4_n) & 0xFF, (uint32) fn00000000000182B4(a3, out a3_n, out a4_n) & 0xFF, (uint32) t1_n & 0xFF, (uint32) a1_n & 0xFF, (uint32) s6_n);
					}
				}
				else
					a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u.in-addr.arpa.", (uint32) s6_n);
			}
			else
				a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u.%u.in-addr.arpa.", (uint32) a1_n & 0xFF, (uint32) s6_n);
		}
		else
			a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u.%u.%u.in-addr.arpa.", (uint32) t1_n & 0xFF, (uint32) a1_n & 0xFF, (uint32) s6_n);
	}
	else
		a0_n.u1 = (uint64) __asprintf_chk(&ptrLoc50, 1, "%u.%u.%u.%u.in-addr.arpa.", (uint32) a0_n & 0xFF, (uint32) t1_n & 0xFF, (uint32) a1_n & 0xFF, (uint32) s6_n);
	int64 a0_n;
	if (a0_n != -1)
	{
		a0_n = ptrLoc50;
...
// 0000000000018118: Register (ptr64 Eq_n) fn0000000000018118(Register (ptr64 Eq_n) gp, Register (ptr64 Eq_n) a0, Register (ptr64 char) a1)
// Called from:
//      fn00000000000175BC
union Eq_n * fn0000000000018118(struct Eq_n * gp, union Eq_n * a0, char * a1)
{
	int64 a5_n = gp->qwF870;
	int64 t4_n = a1 & 3;
	union Eq_n * a0_n;
	if ((a1 & 3) == 0x00)
	{
		...
		if ((a1 & 7) == 4)
		{
			uint64 a5_n = (word64) (&a0->u0)[(word64) (((word32) a1 + 0x04 >> 3) - 1)];
		...
		if (t5_n != 0x00)
		{
			...
			do
			{
				uint64 a5_n = (word64) (&a0->u0)[(word64) (word32) a1_n];
				int64 a3_n = (int64) ((word32) a4_n + 1);
				ui64 a6_n = (a5_n & 0x0F) + 87;
				if ((a5_n & 0x0F) <= 9)
					a6_n = (a5_n & 0x0F) + 48;
				ptr64 fp;
				(fp + -16 + (word64) ((word32) a4_n))->bFEF8 = (byte) a6_n;
				(fp + -16 + (word64) ((word32) a3_n))->bFEF8 = 0x2E;
				int64 a2_n = (int64) ((word32) a4_n + 2);
				int64 a3_n = (int64) ((word32) a4_n + 3);
				uint64 a6_n = (a5_n >> 0x04) + 48;
				if (a5_n >> 0x04 > 9)
					a6_n = (a5_n >> 0x04) + 87;
				(fp + -16 + (word64) ((word32) a2_n))->bFEF8 = (byte) a6_n;
				(fp + -16 + (word64) ((word32) a3_n))->bFEF8 = 0x2E;
				a1_n = (int64) ((word32) a1_n - 1);
				a4_n = (int64) ((word32) a4_n + 4);
			} while (a1_n != -1);
			t4_n = (int64) ((word32) t4_n + ((word32) t5_n << 0x02));
		}
...
// 00000000000182B4: Register int64 fn00000000000182B4(Register int64 a0, Register out ui64 a3Out, Register out int64 a4Out)
// Called from:
//      fn00000000000166F4
//      fn0000000000016830
//      fn0000000000016B68
...
//      fn0000000000017B40
//      fn0000000000017F04
int64 fn00000000000182B4(int64 a0, ui64 & a3Out, int64 & a4Out)
{
	ui64 a3_n = (int64) ((word32) a0 >> 24) | (int64) ((word32) a0 << 0x18);
	a3Out = a3_n;
	int64 a4_n = (int64) (((word32) a0 & 0x00FF0000) >> 0x08);
	a4Out = a4_n;
