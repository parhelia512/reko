...
l0000000100001F1A:
	...
	if (rax_n != 0x00)
	{
		...
		if (cl_n != 0x00)
		{
			...
			do
			{
				if (rbx_n->bFFFE == 0x3A && cl_n == 0x3A)
				{
					rax_n->b0000 = 0x30;
					rax_n[1] = (struct Eq_n) rbx_n->bFFFF;
