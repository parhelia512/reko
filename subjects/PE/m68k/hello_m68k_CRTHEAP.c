...
// 000024B0: void fn000024B0(Register (ptr32 Eq_n) a5, Stack up32 dwArg04)
void fn000024B0(struct Eq_n * a5, up32 dwArg04)
{
	fn000024C4(a5, dwArg04);
}

// 000024C4: Register word32 fn000024C4(Register (ptr32 Eq_n) a5, Stack up32 dwArg04)
// Called from:
//      fn000024B0
word32 fn000024C4(struct Eq_n * a5, up32 dwArg04)
{
	ptr32 fp;
	ptr32 a7_n = fp - 0x0C;
	if (dwArg04 > ~0x1F)
	...
	Eq_n d3_n = SEQ(SLICE(dwArg04 + 0x03, word16, 16), (word16) dwArg04 + 0x03 & ~0x03);
	struct Eq_n * a7_n;
	struct Eq_n * a5_n;
	word32 * a6_n;
	do
	{
		...
		a7_n->u1 = (union Eq_n *) d3_n;
		a7_n = (struct Eq_n *) <invalid>;
		word32 d4_n;
		if (fn00002510(a5, a7_n->u1, out d3_n, out d4_n, out a5_n, out a6_n) != 0x00 || d4_n == 0x00)
			return *a6_n;
		a7_n->a0000[0].u1 = (union Eq_n *) d3_n;
		struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
		a7_n = &a7_n->t0004.u0;
	} while (fn00002644(a5_n, a7_n->a0000[0].u1, out a5, out a6_n) != 0x00);
	return *a6_n;
}

// 00002510: Register uipr32 fn00002510(Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Register out Eq_n d3Out, Register out word32 d4Out, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out)
// Called from:
//      fn000024C4
uipr32 fn00002510(struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, word32 & d4Out, struct Eq_n & a5Out, word32 & a6Out)
{
	word32 a0_n;
	ptr32 fp;
	Eq_n a0_n;
	...
	{
		struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
		if (fn000028A0(a0_n, d0_n, a5, dwArg04, out d3_n, out d4, out a5, out a6_n) == ~0x00)
		{
			word32 * a6_n = *a6_n;
			d3Out.u1 = a7_n->t0008.u1;
			d4Out = d4;
			a5Out = a5;
			a6Out = a6_n;
			return 0x00;
		...
		a7_n->a0000[0].u1 = (union Eq_n *) d3_n;
		struct Eq_n * d0_n = fn000027B0(a5, a7_n->a0000[0].u1, out a0_n);
	...
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - d3_n != 0x04)
	{
		...
		a7_n->t0000.u1 = (union Eq_n *) d3_n;
		a7_n->ptrFFFC = a2_n;
		struct Eq_n * d0_n = fn000025B4(a5, a7_n->ptrFFFC, a7_n->t0000.u1);
		if (d0_n != null)
		{
			Eq_n d0_n;
	...
	a5->tFACC.u1 = a2_n->t0000.u1;
	uipr32 d0_n = a2_n->dw0004;
	word32 * a6_n = *a6_n;
	d3Out.u1 = a7_n->t0004.u1;
	d4Out = d4;
	a5Out = a5;
	a6Out = a6_n;
...
Eq_n fn000025B4(struct Eq_n * a5, struct Eq_n * dwArg04, Eq_n dwArg08)
{
	...
	struct Eq_n * d0_n = (struct Eq_n *) ((char *) &dwArg08.u1->u0 + SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03));
...
// 00002644: Register word32 fn00002644(Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out)
// Called from:
//      fn000024C4
word32 fn00002644(struct Eq_n * a5, Eq_n dwArg04, struct Eq_n & a5Out, word32 & a6Out)
{
	ptr32 fp;
	word32 ** a6_n = fp - 0x04;
	<anonymous> * a0_n = a5->ptrFD34;
	if (a0_n != null)
	{
		a0_n();
		word32 d0_n;
...
l00002758:
	...
	d0_n.u1 = a5->tFAD0.u1;
	a5->tFAD0.u1 = d0_n.u1->dw0000;
	a0_n = d0_n;
	goto l00002758;
}

// 0000275C: Register word32 fn0000275C(Register Eq_n a0, Register (ptr32 Eq_n) a5, Register out Eq_n a0Out)
// Called from:
//      fn0000273C
word32 fn0000275C(Eq_n a0, struct Eq_n * a5, union Eq_n & a0Out)
{
	__syscall<word16>(0xA11E);
	if (a0 != 0x00)
	{
		a5->tFAD0.u1 = (struct Eq_n *) a0;
		Eq_n d0_n = a0;
		Eq_n d1_n;
		d1_n.u1 = (word32) a0 + 8;
		if (true)
		...
		do
		{
			...
			if ((*a3_n & 0x03) == 0x01)
			{
				do
				{
					...
					a0.u1->dw0000 = a5->tFAD0.u1;
					a5->tFAD0.u1 = (struct Eq_n *) a0;
				} while (a0 != (a5->tFACC).u1);
				a5->tFACC.u1 = (struct Eq_n *) a2_n;
				a0.u1 = a2_n.u1->dw0000;
				Eq_n d0_n;
				d0_n.u2 = a0.u1->t0004.u2;
				ui32 d1_n = *a3_n;
...
l0000288C:
			a2_n.u1 = a2_n.u1->dw0000;
		} while (a2_n != (a5->tFACC).u1);
		a0Out = a0;
		return 0x00;
	}
}

// 000028A0: Register word32 fn000028A0(Register Eq_n a0, Register (ptr32 Eq_n) a2, Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Register out Eq_n d3Out, Register out Eq_n d4Out, Register out (ptr32 Eq_n) a5Out, Register out ptr32 a6Out)
// Called from:
//      fn00002510
word32 fn000028A0(Eq_n a0, struct Eq_n * a2, struct Eq_n * a5, Eq_n dwArg04, union Eq_n & d3Out, union Eq_n & d4Out, struct Eq_n & a5Out, ptr32 & a6Out)
{
	ptr32 * a6_n;
	struct Eq_n * a5_n;
	ptr32 fp;
	int32 d4_n = a5->dwFAF4;
	ptr32 * a6_n = fp - 0x04;
	...
	if (d4_n < a5->dwFAE0)
	{
		...
		do
		{
			if (*((char *) &a5->tFADC.u1->a0000[0].u1->a0000[0].u1 + d7_n) != 0x00)
			{
				struct Eq_n * a7_n = a7_n - 4;
				a7_n->dw0000 = d3_n;
				a7_n->dwFFFC = d4_n;
				...
				if (fn00002A54(a5, a7_n->dwFFFC, a7_n->dw0000, out d3_n, out d4_n, out d5_n, out a2_n, out a5, out a6_n) != ~0x00)
				{
					a5->dwFAF4 = d4_n;
					Eq_n d4_n;
...
l000029B4:
		...
		a7_n->dw0000 = d3_n;
		a7_n->dwFFFC = d5_n;
		word32 d0_n = fn000029C8(a0, a5, a7_n->dwFFFC, a7_n->dw0000, out a5_n, out a6_n);
		struct Eq_n * a7_n = (struct Eq_n *) <invalid>;
		Eq_n d4_n;
		d4_n.u2 = a7_n->t000C.u2;
		ptr32 a6_n = *a6_n;
	...
	a5->tFADC.u1 = (struct Eq_n *) a0;
l00002974:
	a0.u1 = a5->tFADC.u1->a0000[0].u1 + a5->dwFAE0 * 0x04;
	uipr32 d0_n = 0x07;
	word16 v30_n;
	do
	{
...
// 000029C8: Register word32 fn000029C8(Register Eq_n a0, Register (ptr32 Eq_n) a5, Stack int32 dwArg04, Stack up32 dwArg08, Register out (ptr32 Eq_n) a5Out, Register out word32 a6Out)
// Called from:
//      fn000028A0
word32 fn000029C8(Eq_n a0, struct Eq_n * a5, int32 dwArg04, up32 dwArg08, struct Eq_n & a5Out, word32 & a6Out)
{
	ptr32 fp;
	word32 d4_n = a5->dwFAEC;
	...
	{
		Eq_n a1_n;
		a1_n.u1 = a5->tFADC.u1->a0000[0].u1;
		...
		struct Eq_n * a1_n = (struct Eq_n *) (a1_n.u1 + dwArg04 * 0x04);
...
l00002A4C:
		...
		a7_n->t0004.u1 = (union Eq_n *) d5_n;
		fn00002AE0(a5, a7_n->t0004.u1);
	}
	d0_n = ~0x00;
	goto l00002A4C;
}

// 00002A54: Register word32 fn00002A54(Register (ptr32 Eq_n) a5, Stack int32 dwArg04, Stack up32 dwArg08, Register out Eq_n d3Out, Register out int32 d4Out, Register out word32 d5Out, Register out uipr32 a2Out, Register out (ptr32 Eq_n) a5Out, Register out (ptr32 word32) a6Out)
// Called from:
//      fn000028A0
//      fn000029C8
word32 fn00002A54(struct Eq_n * a5, int32 dwArg04, up32 dwArg08, union Eq_n & d3Out, int32 & d4Out, word32 & d5Out, uipr32 & a2Out, struct Eq_n & a5Out, word32 & a6Out)
{
	struct Eq_n * a2_n = (struct Eq_n *) (a5->tFADC.u1->a0000[0].u1 + dwArg04 * 0x04);
	...
	if (d3_n > d0_n)
	{
		...
		a2_n = (struct Eq_n *) (a5->tFADC.u1->a0000[0].u1 + dwArg04 * 0x04);
		if (a5->tFAF0.u1->a0000[0].u0 != 0x00)
		{
			Eq_n d3;
			d3Out = d3;
			int32 d4;
	...
	int32 d4_n = a7_n->dw0000;
	word32 d5_n = a7_n->dw0004;
	uipr32 a2_n = a7_n->dw0008;
	word32 * a6_n = *a6_n;
	d3Out.u1 = a7_n->a0000[0].u1;
	d4Out = d4_n;
	d5Out = d5_n;
	a2Out = a2_n;
	a5Out = a5_n;
...
{
	if (a5->tFADC.u1->a0000[0].u1[dwArg04 * 0x04] != 0x00)
		__syscall<word16>(0xA01F);
	Eq_n a0_n;
	a0_n.u1 = a5->tFADC.u1->a0000[0].u1;
	((word128) a0_n + dwArg04 * 0x10)->u0 = 0x00;
	((word128) a0_n + (dwArg04 * 0x10 + 4))->u1 = 0x00;
	((word128) a0_n + (dwArg04 * 0x10 + 8))->u1 = 0x00;
}
...
void fn00002B18(struct Eq_n * a5, struct Eq_n * dwArg04)
{
	if (dwArg04 != null)
	{
		...
		if (a5->dwFAE4 != ~0x00 && d0_n < (((a5->tFACC).u1)->t0004).u2)
		{
			word32 d1_n = *((word32) a2_n.u1->dw0000 + 4);
			if (SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - 0x04 >= a5->dwFAE4)
				a5->tFACC.u1 = (struct Eq_n *) a2_n;
		}
	}
}

// 00002BB4: Register word32 fn00002BB4(Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Stack Eq_n dwArg08, Register out (ptr32 Eq_n) a5Out, Register out word32 a6Out)
// Called from:
//      fn00002A54
word32 fn00002BB4(struct Eq_n * a5, Eq_n dwArg04, Eq_n dwArg08, struct Eq_n & a5Out, word32 & a6Out)
{
	Eq_n tLoc08;
	ptr32 fp;
	...
	if (fn0000273C(fp + ~0x17, a5, out a0_n) != 0x00 && (fn0000273C(a0_n, a5, out a0_n) != 0x00 && fn0000273C(a0_n, a5, out a0_n) != 0x00))
	{
		...
		if (d0_n <= 0x00)
		{
			...
			{
			case ~0x02:
				a5->ptrFAD8 = dwArg04 + dwArg08;
				fn00002E18(a3_n, dwArg08, (char *) &a5->tFAD0 + 4, &tLoc1C);
				a5->tFACC.u1 = (struct Eq_n *) a3_n;
				a5->tFAC8.u1 = (struct Eq_n *) a3_n;
				break;
			case ~0x01:
				struct Eq_n * a7_n = fp - 0x24;
				if (fn00002EA8(a5, a5->ptrFAD8 - 0x01, &tLoc08) != 0x01)
				{
					a5 = fn000027A0(a5, fp - 0x04, out a6_n);
					a7_n = (struct Eq_n *) <invalid>;
				}
				word32 d1_n = a6_n->ptrFFFC->ptr0000->dw0004;
				word32 d0_n = a6_n->ptrFFFC->dw0004;
				a5->ptrFAD8 = &dwArg04.u2->t0000.u0 + a6_n->dw000C;
				a3_n.u1->dw0000 = (char *) &a5->tFAD0 + 4;
				struct Eq_n * a7_n = a7_n - 4;
				a7_n->ptr0000 = (char *) a6_n - 24;
				a7_n->tFFFC.u1 = (struct Eq_n *) a3_n;
				a7_n->dwFFF8 = SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03);
				a7_n->ptrFFF4 = a6_n->ptrFFFC;
				a7_n = a7_n - 0x0C;
				goto l00002DA4;
			case ~0x00:
				fn00002E18(a3_n, dwArg08, a5->tFAC8.u1, &tLoc1C);
				a5->tFAC8.u1 = (struct Eq_n *) a3_n;
				break;
			}
			goto l00002DAC;
		...
		if ((a0_n->dw0004 & 0x03) == 0x02)
		{
			if ((char *) &a5->tFAD0 + 4 == a0_n->ptr0000)
			{
				Eq_n d0_n;
...
l00002DAC:
			Eq_n d0_n;
			d0_n.u2 = a5->tFACC.u1->t0004.u2;
			if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) > dwArg04)
			{
				word32 d0_n = *((word32) a3_n.u1->dw0000 + 4);
				Eq_n d1_n;
				d1_n.u2 = a3_n.u1->t0004.u2;
				if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) - SEQ(SLICE(d1_n, word16, 16), (word16) d1_n & ~0x03) - 0x04 >= a5->dwFAE4)
					a5->tFACC.u1 = (struct Eq_n *) a3_n;
			}
			word32 a6_n = a6_n->dw0000;
			a5Out = a5;
			a6Out = a6_n;
			return 0x00;
		}
...
l00002DE8:
	while (*tLoc1C != 0x00)
	{
		**tLoc1C = (Eq_n) a5->tFAD0.u1;
		a5->tFAD0.u1 = (struct Eq_n *) *tLoc1C;
		tLoc1C = (Eq_n) ((word32) tLoc1C + 4);
	}
	a5Out = a5;
	word32 a6;
...
// 00002EA8: Register word32 fn00002EA8(Register (ptr32 Eq_n) a5, Stack Eq_n dwArg04, Stack (ptr32 Eq_n) dwArg08)
// Called from:
//      fn00002BB4
word32 fn00002EA8(struct Eq_n * a5, Eq_n dwArg04, union Eq_n * dwArg08)
{
	if ((char *) &a5->tFAD0 + 4 == (a5->tFAC8).u1)
		return ~0x02;
	Eq_n d0_n;
	d0_n.u2 = a5->tFAC8.u1->t0004.u2;
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) > dwArg04)
		return ~0x00;
	ptr32 d0_n = a5->ptrFAD8;
	if (SEQ(SLICE(d0_n, word16, 16), (word16) d0_n & ~0x03) <= dwArg04)
		return ~0x01;
	Eq_n a1_n;
	a1_n.u1 = a5->tFAC8.u1;
